...
public class FrequenciaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(action_bar != null) {
            action_bar.setTitle("Convertidor de Frecuancia");
        ...
        convert_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    FrequenciaConvertidor.Unit fromUnit1 = FrequenciaConvertidor.Unit.fromString(fromUnit);
                    FrequenciaConvertidor.Unit toUnit1 = FrequenciaConvertidor.Unit.fromString(toUnit);

                    FrequenciaConvertidor converter = new FrequenciaConvertidor(fromUnit1, toUnit1);
                    ...
                    outlinedTextField_frequency_unit.setError("Por favor ingrese algún valor");
