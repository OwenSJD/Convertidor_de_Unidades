...
public class TemperaturaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(action_bar != null) {
            action_bar.setTitle("Convertidor de Temperatura");
        ...
        convert_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    TemperaturaConvertidor.Unit fromUnit1 = TemperaturaConvertidor.Unit.fromString(fromUnit);
                    TemperaturaConvertidor.Unit toUnit1 = TemperaturaConvertidor.Unit.fromString(toUnit);

                    TemperaturaConvertidor converter = new TemperaturaConvertidor(fromUnit1, toUnit1);
                    ...
                    outlinedTextField_temperature_unit.setError("Por favor ingrese algún valor");
